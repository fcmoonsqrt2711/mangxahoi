...
//                return null;
    ...
    //tutinh
    public static String postAndReturnString2(String sUrl, Object obj) {
...
//                return null;
    ...
    //tutinh: tăng timeout lên
    public static List postAndReturnObjectArray2(String sUrl, Object obj, Class clazz) {
        String result = postAndReturnString2(sUrl, obj);
    ...
    public static String postAndReturnStringNoTimeOut(String sUrl, Object obj) {
        ...
        try {
            ...
            conn.setDoOutput(true);
            conn.setRequestProperty("Content-Type", "application/json");
            conn.setConnectTimeout(864000000);
            conn.setReadTimeout(864000000);
...
//                return null;
    ...
    public static Object postAndReturnObjectNoTimeOut(String sUrl, Object paramObject, Class resultClass) {
        String result = postAndReturnStringNoTimeOut(sUrl, paramObject);
        if (result == null) {
            return null;
        }
