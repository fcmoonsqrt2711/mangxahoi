...
public class NotifyRsServiceImpl implements NotifyRsService {
    ...
    @Override
    public Response seenALL(SearchCommonFinalDTO searchDTO, Integer offset, Integer limit) {
        ServiceResult result = notifyBusinessImpl.seenALL(searchDTO, offset, limit);
