...
public class Base64Utils {
    ...
    public static boolean encodeToFile(byte[] dataToEncode, String filename) {
        ...
        try {
            in = new java.io.FileOutputStream(
                    filename);
            bos = new Base64Utils.OutputStream(in, Base64Utils.ENCODE
            );
    ...
    public static boolean decodeToFile(String dataToDecode, String filename) {
        ...
        try {
            in = new java.io.FileOutputStream(
                    filename);
            bos = new Base64Utils.OutputStream(in, Base64Utils.DECODE);
    ...
    public static byte[] decodeFromFile(String filename) {
        ...
        try {
            ...
            // Open a stream
            inFS = new java.io.FileInputStream(file);
            bis = new Base64Utils.InputStream(new java.io.BufferedInputStream(
                    inFS), Base64Utils.DECODE);
    ...
    public static String encodeFromFile(String filename) {
        ...
        try {
            ...
            encodedData = new String(buffer, 0, length,
                    Base64Utils.PREFERRED_ENCODING);
    ...
    public static boolean encodeFileToFile(String infile, String outfile) {
        ...
        try {
            inF = new java.io.FileInputStream(infile);
            outF = new java.io.FileOutputStream(outfile);
            in = new Base64Utils.InputStream(new java.io.BufferedInputStream(
                    inF), Base64Utils.ENCODE);
                    ...
                    switch (j) {
                        ...
                        default:
                            ...
                            throw new java.io.IOException(
                                    "Improperly padded Base64 input."); // end
                    }
